        ...
        return (
            <div><br/><br/>
                <Card>
                    ...
                    <ReactPlaceholder type='text' ready={this.state.content} color='#E0E0E0' rows={4} showLoadingAnimation={true}>
                    ...
                    <div>
                        ...
                        {this.state.showComments ? (<>{ this.commentsList() }<AddComment post={this.state.post} setRefresh={this.setRefresh}/></>) : (<></>)}
                    </div>
                    </Card.Body>
                </Card>
